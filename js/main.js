...
var FARO_GIDS = {
  controle: { pose: 'idle', stem: 'nuchter', plek: 'rechtsmidden',
              nl: 'Wat een agent zelf mag doen, zet jij. Per actietype, niet één schakelaar voor alles.',
              en: 'What an agent may do on its own is yours to set. Per action type, not one switch for everything.',
              fr: 'Ce qu’un agent peut faire seul, c’est vous qui le décidez. Par type d’action, pas un seul interrupteur pour tout.',
              de: 'Was ein Agent selbst darf, bestimmen Sie. Je Aktionstyp, nicht ein Schalter für alles.',
              es: 'Lo que un agente puede hacer por su cuenta lo decides tú. Por tipo de acción, no un solo interruptor para todo.' },
  ...
  stroom: { pose: 'thinking', stem: 'wijst', plek: 'linksonder',
              ...
              fr: 'Votre client arrive à gauche, votre planning est à droite. Tout ce qui se trouve entre les deux, c’est Helvaro.',
              de: 'Links kommt Ihr Kunde herein, rechts steht Ihre Planung. Alles dazwischen ist Helvaro.',
              es: 'Tu cliente entra por la izquierda y tu planning está a la derecha. Todo lo que hay en medio es Helvaro.' },
  probleem: { pose: 'thinking', stem: 'ernstig', plek: 'rechtsmidden',
              nl: 'Drie plekken waar werk weglekt. Geen ervan gaat over te weinig klanten.',
              en: 'Three places where work leaks away. None of them are about having too few customers.',
              fr: 'Trois endroits où le travail se perd. Aucun ne concerne un manque de clients.',
              de: 'Drei Stellen, an denen Arbeit versickert. Keine davon hat mit zu wenigen Kunden zu tun.',
              es: 'Tres puntos por donde se escapa trabajo. Ninguno tiene que ver con tener pocos clientes.' },
  ...
  verschil: { pose: 'idle', stem: 'nuchter', plek: 'rechtsboven',
              ...
              fr: 'Chatbot, agent isolé, système. Ils se ressemblent jusqu’à ce qu’on regarde ce qui arrive vraiment dans le planning.',
              de: 'Chatbot, einzelner Agent, System. Sie ähneln sich, bis man sieht, was wirklich in der Planung landet.',
              es: 'Chatbot, agente suelto, sistema. Se parecen hasta que miras qué acaba de verdad en tu planning.' },
  ...
  binnen: { pose: 'generating', stem: 'werkt', plek: 'rechtsonder',
              ...
              fr: 'Tout ce qui arrive reçoit une réponse. Même à dix-huit heures moins le quart, même le samedi.',
              de: 'Was hereinkommt, bekommt eine Antwort. Auch um Viertel vor sechs, auch samstags.',
              es: 'Todo lo que entra recibe respuesta. También a las seis menos cuarto, también el sábado.' },
  uitgaand: { pose: 'generating', stem: 'port', plek: 'linksonder',
              nl: 'Je weet welke auto’s binnenkort moeten komen. Wachten tot ze bellen is geen plan.',
              en: 'You know which cars are due soon. Waiting for them to call is not a plan.',
              fr: 'Vous savez quelles voitures doivent bientôt passer. Attendre qu’elles appellent n’est pas un plan.',
              de: 'Sie wissen, welche Autos demnächst dran sind. Darauf zu warten, dass sie anrufen, ist kein Plan.',
              es: 'Sabes qué coches tocan pronto. Esperar a que llamen no es un plan.' },
  kenteken: { pose: 'thinking', stem: 'speurt', plek: 'rechtsmidden',
              ...
              fr: 'Sept caractères, et le système sait déjà quelle voiture arrive et quand le contrôle expire.',
              de: 'Sieben Zeichen, und das System weiß bereits, welches Auto kommt und wann die Hauptuntersuchung abläuft.',
              es: 'Siete caracteres, y el sistema ya sabe qué coche viene y cuándo caduca la inspección.' },
  agents: { pose: 'success', stem: 'trots', plek: 'linksmidden',
              nl: 'Tien werkstromen, maar één geheugen en één planning eronder.',
              en: 'Ten workflows, but one shared memory and one planning underneath.',
              fr: 'Dix flux de travail, mais une seule mémoire et un seul planning en dessous.',
              de: 'Zehn Arbeitsabläufe, aber ein gemeinsames Gedächtnis und eine Planung darunter.',
  ...
  faro: { pose: 'idle', stem: 'nieuwsgierig', plek: 'linksonder',
              nl: 'Dit ben ik. Ik ben geen losse agent, maar de laag waarin je meeleest, goedkeurt en vragen stelt.',
              en: 'This is me. I am not a separate agent, but the layer where you read along, approve and ask questions.',
              fr: 'C\'est moi. Je ne suis pas un agent à part, mais la couche où vous suivez, validez et posez des questions.',
              de: 'Das bin ich. Ich bin kein einzelner Agent, sondern die Schicht, in der Sie mitlesen, freigeben und Fragen stellen.',
              es: 'Este soy yo. No soy un agente aparte, sino la capa en la que lees, apruebas y preguntas.' },
